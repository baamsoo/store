...
public class MemberController {
    ...
    public String index(Model model) {
        ...
        List<Member> memberEntityListExcludingFirst = new ArrayList<>(memberEntityList);
    
        model.addAttribute("memberList", memberEntityListExcludingFirst);
        if (!memberEntityList.isEmpty()) {
            memberEntityListExcludingFirst.remove(0);
        }
